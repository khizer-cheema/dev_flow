...
const StatsCard = ({imgUrl,value,title}:StatsCardProps)=>(
  <div className='light-border background-900_dark300 flex-wrap items-center justify-start gap-4 rounded-md p-6 shadow-light-300 dark:shadow-dark-200 border flex'>
    <Image
      src={imgUrl}
      alt={title}
      width={40}
