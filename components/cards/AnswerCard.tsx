...
const AnswerCard = ({
  _id,author,content,createdAt,upvotes,downvotes,question,containerClasses,showReadMore=false,
  ...
  return (
    <article className={cn("light-border border-b py-10 relative", containerClasses)}>
      <span id={`answer-${_id}`} className="hash-span" />
        {
          showActionBtns && (
            <div className='background-light800 flex-center absolute -right-2 -top-5 rounded-full'>
              <EditDeleteAction
                type='Answer'
                itemId={_id}
              />
      ...
      <div className='mb-5 flex flex-col-reverse justify-between gap-5 sm:flex-row sm:items-center sm:gap-2'>
        <div className='flex flex-1 items-start gap-1 sm:items-center'>
          ...
          <Link
            ...
            className="flex flex-col sm:flex-row max-sm:ml-1 sm:items-center"
          >
